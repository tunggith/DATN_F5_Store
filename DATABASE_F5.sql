...
THOI_GIAN_TAO DATETIME,
SO_TIEN_HOA_DON_TOI_THIEU MONEY,
GIA_TRI_GIAM_TOI_THIEU INT,
...
CONSTRAINT FK_HOA_DON_THANH_TOAN FOREIGN KEY(ID_THANH_TOAN) REFERENCES THANH_TOAN(ID)
);
...
TEN NVARCHAR(255),
GIA_TRI_VOUCHER INT,
KIEU_KHUYEN_MAI VARCHAR(5), --kiểu giảm giá - % hay $
MOTA NVARCHAR(255),
SO_LUONG INT,
